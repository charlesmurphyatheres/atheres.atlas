...
namespace Atheres.Atlas.Data.Migrations.Identity
{
    ...
    partial class AtlasIdentityDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Atheres.Atlas.Data.Entities.ApplicationUser", b =>
            {
                ...
                b.Property<string>("FirstName").HasMaxLength(100).IsRequired().HasColumnType("nvarchar(100)");
                b.Property<bool>("IsActive").HasDefaultValue(true).HasColumnType("bit");
                b.Property<DateTime?>("LastLoginAt").HasColumnType("datetime2");
                b.Property<string>("LastName").HasMaxLength(100).IsRequired().HasColumnType("nvarchar(100)");
                ...
                b.Property<Guid?>("RouteSettingsUserId").HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Atheres.Atlas.Data.Entities.RefreshToken", b =>
            {
                b.Property<Guid>("Id").HasColumnType("uniqueidentifier");
                b.Property<DateTime>("CreatedAt").HasColumnType("datetime2");
                b.Property<DateTime>("ExpiresAt").HasColumnType("datetime2");
                b.Property<bool>("IsRevoked").HasDefaultValue(false).HasColumnType("bit");
                b.Property<string>("ReplacedByToken").HasColumnType("nvarchar(max)");
                b.Property<string>("RevokedReason").HasColumnType("nvarchar(max)");
                b.Property<string>("Token").HasMaxLength(512).IsRequired().HasColumnType("nvarchar(512)");
                ...
                b.HasIndex("UserId").HasDatabaseName("IX_RefreshTokens_UserId");
            ...
            {
                b.Property<int>("Id").HasColumnType("int").ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Atheres.Atlas.Data.Entities.RefreshToken", b =>
            {
                b.HasOne("Atheres.Atlas.Data.Entities.ApplicationUser", "User")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
            {
                b.HasOne("Atheres.Atlas.Data.Entities.ApplicationUser", null)
                 .WithMany()
                 .HasForeignKey("UserId")
                 .OnDelete(DeleteBehavior.Cascade)
                 .IsRequired();
