...
/// <summary>
/// SendGrid-backed mail sender used for the OrderImporter invitation flow.
/// Mirrors <c>Atheres.Atlas.Functions.Services.SendGridEmailService</c> but
/// lives here because Auth.Functions doesn't reference the main Functions
/// project.
/// </summary>
public class SendGridEmailService : IEmailService
{
    ...
    // DEBUG: redirect all outbound mail to this inbox while we tighten down
    // the live SendGrid templates / domain auth. Keep this in sync with the
    // main Functions project's copy until both are removed.
