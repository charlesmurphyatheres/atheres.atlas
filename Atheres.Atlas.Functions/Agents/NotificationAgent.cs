...
public class NotificationAgent
{
    ...
    public async Task<HttpResponseData> Negotiate(
        ...
        [SignalRConnectionInfoInput(HubName = "atlas-hub", ConnectionStringSetting = "AzureSignalRConnectionString")] SignalRConnectionInfo connectionInfo)
    {
    ...
    [SignalROutput(HubName = "atlas-hub", ConnectionStringSetting = "AzureSignalRConnectionString")]
