...
public static class Roles
{
    ...
    public static readonly IReadOnlyList<string> AdminAssignableRoles = [Logistics, Driver];

    /// <summary>All roles that exist within a company tenant.</summary>
    public static readonly IReadOnlyList<string> CompanyRoles = [Admin, Logistics, Driver];

    /// <summary>Every role in the system.</summary>
    public static readonly IReadOnlyList<string> All = [SuperAdmin, Admin, Logistics, Driver];
}
